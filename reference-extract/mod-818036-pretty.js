...
,
        followers: {
 label: 'Followers', unit: 'count', sub: 'Kick followers' }
,
        'avg-viewers': {
...
,
 ...
 value: e, label: F[e].label }
))
    function P ({
 streamers: e, casinoOptions: s, onClose: r }
) {
 ...
 : {
        ...
        R = (0, a.useCallback)(e => {
          ...
          return (function (e, t, a, s) {
            ...
            let r = `/api/og/streamers?metric=${
e}
`
            for (let e of (t && (r += `&casino=${
...
(0, a.useEffect)(() => {
        ...
        ;
(0, V.track)('quick_share_preview_opened', {
 mode: 'streamers-top' }
)
      }
, []),
...
mo ago`
    ...
    let D = e =>
      `https://cdn.fairgambling.com/pfps/${
e.trim().toLowerCase()}
.webp`
    function R ({
 name: e, src: s, size: r = 32, rounded: l = 'rounded-full' }
) {
...
l}
 bg-gradient-to-b from-[#9a80f9] to-[#322098] font-semibold text-white`,
            style: {
 width: r, height: r, fontSize: Math.round(0.4 * r) }
,
...
,
 ...
 label: 'Leaderboard', key: 'leaderboard', right: !0, w: 120 }
      ...
      X = {
        ...
        Live: {
 key: 'liveviewers', dir: 'desc' }
,
        'Most Valuable': {
 key: 'marketvalue', dir: 'desc' }
,
        Newcomers: {
 key: 'newcomer', dir: 'desc' }
...
`,
          ...
          (0, t.jsx)('td', {
            ...
            className: `${
ee}
 text-right text-[rgba(42,39,78,0.8)] dark:text-white/80`,
...
K}
 ...
 text-[12px]`,
          ...
          (0, t.jsx)('td', {
            ...
            className: `${
K}
 text-right text-[rgba(42,39,78,0.8)] dark:text-white/80 text-[12px]`,
            children: e.avgViewers30d > 0 ? T(e.avgViewers30d) : '—'
          }
),
          (0, t.jsx)('td', {
...
, [e]),
 ...
 key: a, dir: -1 }
                              ...
                              className: `${
W}
 sticky top-0 z-10 !px-2.5 backdrop-blur-md ${
i}
 ${
                          ...
                          'tr',
                          {
                            ...
                            children: [
                              (0, t.jsx)('td', {
                                ...
                                className: `${
K}
 !px-2.5 !pl-3 text-[rgba(42,39,78,0.4)] dark:text-white/35`,
                                children: a + 1
                              }
),
                              (0, t.jsx)('td', {
...
K}
 !px-2.5`,
                              ...
                              (0, t.jsx)('td', {
                                ...
                                className: `${
K}
 hidden !px-2.5 text-right text-[rgba(42,39,78,0.8)] dark:text-white/80 sm:table-cell`,
...
%`
                              ...
                              (0, t.jsx)('td', {
                                ...
                                className: `${
K}
 !px-2.5 text-right font-medium text-[#2a274e] dark:text-white`,
          ...
          (0, t.jsxs)('span', {
            ...
            children: [
              ...
              (0, t.jsx)('span', {
                ...
                style: {
 boxShadow: '0 0 6px rgba(247,87,95,0.8)' }
                                  ...
                                  children: [
                                    ...
                                    (0, t.jsx)('div', {
                                      ...
                                      style: {
                                        ...
                                        background: `radial-gradient(90% 80% at 85% 15%, ${
a}
30, transparent 55%)`
                                      }
          ...
          return t
            ? !(function (e, t) {
                ...
                try {
                  ...
                  let a = new URL(/^https?:\/\//i.test(e) ? e : `https://${
e}
`),
...
e}
3d, transparent 55%), radial-gradient(90% 80% at 90% 100%, ${
e}
2b, transparent 50%), linear-gradient(155deg, #161a2b 0%, #0c0f19 70%)`
    function eM ({
...
,
        className: `group relative flex h-full min-h-[300px] cursor-pointer flex-col justify-end overflow-hidden rounded-[20px] ring-1 ring-white/[0.08] transition-[flex-grow,box-shadow] duration-[900ms] ease-out hover:ring-white/20 ${
n}
`,
        children: [
          e.image
                ...
                children:
                  ...
                  (0, t.jsx)(
                    'span',
                    {
                      ...
                      style: {
 animation: 'fgNewsFill 7500ms linear forwards' }
 ...
 streamers: e }
    ...
    e.s(
      [
        ...
        0,
        function ({
 platform: e, height: a = 12, className: s = '' }
) {
